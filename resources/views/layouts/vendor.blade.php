        ...
        <div class="ad-profile section">
            <div class="user-profile">
                ...
                <div class="favorites-user">
                    <div class="my-ads">
                        <a href="my-ads.html">{{$referralsBoughtCount}}<small>Referrals</small></a>
                    </div>
                    <div class="favorites">
                        <a href="#">{{$subscribedCategoriesCount}}<small>Categories</small></a>
                    </div>
                </div>
            </div><!-- user-profile -->
            ...
            <ul class="user-menu">
                ...
                <li><a href="{{ route('vendor-referrals-bought') }}">Referrals</a></li>
                <li><a href="{{ route('vendor-categories') }}">Categories </a></li>
                <li><a href="{{ route('vendor-settings-profile') }}">Profile</a></li>
                <li><a href="{{ route('vendor-settings-password') }}">Account</a></li>
            </ul>
        </div><!-- ad-profile -->
