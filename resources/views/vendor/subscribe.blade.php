    ...
    <div class="user-profile">
        ...
        <div style="padding:30px;margin:auto">
            ...
            <div class="col-md-offset-3 col-md-6">
                ...
                <center>
                    <h3>Your account is not active. Please renew your subscription to re-enable your service.</h3>
                    <br>
                    ...
                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                        ...
                        <input type="hidden" name="hosted_button_id" value="LA2L6TG82MQBG">
                        <input type="hidden" name="custom" value="{{ $user_id }}">
                        <input type="submit" value="Subscribe with Paypal" name="submit" title="PayPal - The safer, easier way to pay online!" class="btn btn-primary">
                    ...
                    <p>If you've just renewed your subscription, please allow a few minutes for processing to complete.</p>
                    <a class="btn btn-sm btn-default" href="{{\Illuminate\Support\Facades\URL::to('/vendor')}}">
