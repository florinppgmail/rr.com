                            ...
                            <div class="panel-body">
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        <table id="datatable_payments_approved" class="table table-hover display  pb-30" >
                                            <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Member Name</th>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var membersTable = $('#datatable_payments_approved').DataTable({
                ajax: {
                    url: '{{ route('admin-payments-approved-all') }}',
                    type: 'POST',
            ...
            $('#datatable_payments_approved tbody').on('click', 'tr td.details-control', function () {
