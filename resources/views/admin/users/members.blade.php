    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var membersTable = $('#datable_members').DataTable({
                ajax: {
                    url: '{{ route('admin-users-members-all') }}',
                    type: 'POST',
                ...
                "fnDrawCallback": function (oSettings, json) {
                    $('#datable_members').find('button.disable-user').on('click', function () {
            ...
            $('#datable_members tbody').on('click', 'tr td.details-control', function () {
