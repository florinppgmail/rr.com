                            ...
                            <div class="panel-body">
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        <table id="datatable_referrals_free" class="table table-hover display  pb-30" >
                                            <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Name</th>
...
@section('script')
    ...
    <script>
        function format(d) {
            ...
            let viewers = d.viewers.length ? '' : 'There are no viewers for this referral';

            d.viewers.forEach(function(itm){
                viewers = viewers +
                '<tr>' +
                '<td style="width:40%"><strong>' + itm.name + '</strong></td>' +
                '<td style="width:60%">' + itm.email + '</td>' +
                '</tr>';
            });
        ...
        $(document).ready(function() {
            ...
            var membersTable = $('#datatable_referrals_free').DataTable({
                ajax: {
                    url: '{{ route('admin-referrals-free-all') }}',
                    type: 'POST',
...
/*                    {'data': 'city', 'width': '15%'},*/
            ...
            $('#datatable_referrals_free tbody').on('click', 'tr td.details-control', function () {
