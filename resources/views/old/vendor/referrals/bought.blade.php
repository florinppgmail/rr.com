        ...
        <div class="container-fluid">
            ...
            <div class="row heading-bg">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark">Bought referrals list</h5>
                </div>
                <!-- Breadcrumb -->
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><span>Bought</span></li>
                    </ol>
                </div>
                <!-- /Breadcrumb -->
            </div>
                            ...
                            <div class="panel-body">
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        <table id="datable_referrals" class="table table-hover display  pb-30" >
                                            <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Name</th>
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            var referralsTable = $('#datable_referrals').DataTable({
                ajax: {
                    url: '{{ route('vendor-referrals-bought') }}',
                    type: 'POST',
