    ...
    <nav class="navbar navbar-default">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><img class="img-responsive" src="{{ asset('dashboard/dist/img/logo_smallest.png') }}" alt="Logo"></a>
            </div>
            <!-- /navbar-header -->
            ...
            <div class="nav-right">
                ...
                <ul class="sign-in">
                    ...
                    <li><a href="signin.html">Sign In </a></li>
                    &nbsp;&nbsp;<li><a href="signup.html">Vendor SIGNUP</a></li>
